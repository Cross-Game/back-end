...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers(HttpMethod.POST, FRIENDS_ANY_URL).permitAll()
                .antMatchers(HttpMethod.GET, FRIENDS_ANY_URL).permitAll()
                .antMatchers(HttpMethod.DELETE, FRIENDS_ANY_URL).permitAll()
